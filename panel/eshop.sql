...
--
-- Table structure for table `stats_orders`
--
...
--
-- Table structure for table `stats_products`
--

CREATE TABLE `stats_products` (
  `product_id` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Indexes for table `stats_orders`
--
ALTER TABLE `stats_orders`
  ADD PRIMARY KEY (`date`);

--
-- Indexes for table `stats_products`
--
ALTER TABLE `stats_products`
...
--
-- Constraints for table `stats_products`
--
ALTER TABLE `stats_products`
  ADD CONSTRAINT `stats_products_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
COMMIT;
